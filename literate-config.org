...
Change these key-value with your prefer.
...
- [X] Hide export options (title/author/date/email..)
#+begin_src emacs-lisp :tangle "~/.doom.d/config.el"
;; Hide export options
...
(after! org
  ...
  (setq org-agenda-start-on-weekday nil
        ...
        org-agenda-diary-file (concat org-directory "private/standard-diary")
        org-agenda-files (list (concat org-directory "roam/"))
        diary-file (concat org-directory "private/standard-diary")))
#+end_src
...
(map!
 ...
 :leader :desc "Find file" "f f" #'counsel-find-file
...
;; Use valign package to solve table align proble   m
(use-package! valign
  :config
